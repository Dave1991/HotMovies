...
/*状态栏高度和导航栏高度总和*/
#define HeaderHeight [UIApplication sharedApplication].statusBarFrame.size.height+self.navigationController.navigationBar.frame.size.height

//NSString *kNotifReceivedMessage = @"receivedFriendMessage";
#define kNotifReceivedMessage @"receivedFriendMessage"
#define kNotifUpdateUnread  @"updateUnreadCount"
//测试服务器
//#define kServerIP       @"http://123.56.109.77/yuedao/"
//正式服务器
#define kServerIP       @"http://182.92.85.130/yuedao/"

//** textAlignment ***********************************************************************************
//应用主颜色
#define MainColor       UIColorFromRGB(0xFF840F)
#define NavigatorColor  UIColorFromRGB(0x01BADF)
#define GrayColor       UIColorFromRGB(0xF7F7F7)
